This is a library management system that will first read the input of student info and book info from a txt file, and then can perform the following functions: 
